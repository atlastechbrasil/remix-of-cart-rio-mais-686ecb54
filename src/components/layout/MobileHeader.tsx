...
export function MobileHeader() {
  ...
  return (
    <header className="sticky top-0 z-40 flex lg:hidden items-center justify-between h-14 px-4 border-b border-primary/20 bg-primary text-primary-foreground">
      {/* Left: Hamburger + Logo */}
      ...
      {cartorioAtivo && (
        <div className="flex-1 mx-4 min-w-0">
          <p className="text-sm font-medium truncate text-center text-primary-foreground/80">
            {cartorioAtivo.nome}
          </p>
        </div>
      )}
