...
export function MobileHeader() {
  ...
  return (
    <header className="sticky top-0 z-40 flex lg:hidden items-center justify-between h-14 px-4 border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      {/* Left: Hamburger + Logo */}
